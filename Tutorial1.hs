...
-}
curry1 :: ((a, b) -> c) -> a -> b -> c
curry1 f x y = f (x, y) --TODO

uncurry1 :: (a -> b -> c) -> (a, b) -> c
uncurry1 f (x, y) = f x y --TODO

prop_curry_add :: Int -> Int -> Bool
prop_curry_add x y = undefined --TODO
...
prop_leap j = undefined --TODO

-- Exercise --
safetail1 :: [a] -> [a]
safetail1 xs = undefined --TODO

safetail2 xs = undefined --TODO

safetail3 xs = undefined --TODO

safetail4 xs = undefined --TODO
